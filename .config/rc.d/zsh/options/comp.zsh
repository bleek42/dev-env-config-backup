...
## ?     for the terminal/OpSys combination in question.
## ?
...
zstyle ':completion:*' completer _expand .force_rehash _complete _match _files _extensions _ignored
...
if command -v fzf >/dev/null 2>&1; then
    ...
    *)
    ...
    # export FZF_DEFAULT_COMMAND='fd -H -L -i'
    export FZF_DEFAULT_COMMAND='ag -l -S --hidden -g "" --ignore .git'
    ...
    __fzf_default_preview_window="right:60%:hidden:border-sharp:wrap:~4"
