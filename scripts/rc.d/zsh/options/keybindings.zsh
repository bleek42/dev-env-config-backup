...
if [[ -n "${key[Ctrl+Delete]}" ]]; then
    bindkey -M emacs "${key[Ctrl+Delete]}" kill-word
    bindkey -M viins "${key[Ctrl+Delete]}" kill-word
    bindkey -M vicmd "${key[Ctrl+Delete]}" kill-word
fi

# [Ctrl-RightArrow] - move forward one word
if [[ -n "${key[Ctrl+Right]}" ]]; then
    bindkey -M emacs "${key[Ctrl+Right]}" forward-word
    bindkey -M viins "${key[Ctrl+Right]}" forward-word
    bindkey -M vicmd "${key[Ctrl+Right]}" forward-word
fi

# [Ctrl-LeftArrow] - move backward one word
if [[ -n "${key[Ctrl+Left]}" ]]; then
    bindkey -M emacs "${key[Ctrl+Left]}" backard-word
    bindkey -M viins "${key[Ctrl+Left]}" backard-word
    bindkey -M vicmd "${key[Ctrl+Left]}" backard-word
fi
...
bindkey -M emacs "${key[Shift+Home]}" tmux-which-key
