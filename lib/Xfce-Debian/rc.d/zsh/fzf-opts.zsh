...
typeset AG_DEFAULT_COMMAND='ag -i -l --hidden -g'
typeset RG_DEFAULT_COMMAND='rg -i --pretty --hidden --no-ignore-vcs'
...
export FZF_PREVIEW="
		--preview '([[ -f {} ]] && (batcat --color=always -n -p {} | less)) || ([[ -d {} ]] && (treex {}) || (tree -C {} | less -R -f)) || echo {} 2> /dev/null | head -200'"
