...
#     zstyle ':fzf-tab:complete:*' fzf-preview 'less ${(Q)realpath#-*=} || less ${(Q)realpath#-*=}'

#     zstyle ':fzf-tab:complete:*' fzf-bindings \
#         '~:accept' \
#         'ctrl-v:execute-silent({_FTB_INIT_}code || code.exe $realpath)' \
#         'ctrl-e:execute-silent({_FTB_INIT_}micro || nano $realpath)'
...
#             ;;
#             "executable file") batcat --style=numbers --color=always -n=4 || less ${realpath#--*=}
#             ;;
#             "builtin command") $word --help | batcat --style=numbers --color=always -n=4 || less
#             ;;
...
#     zstyle ':fzf-tab:complete:px-*:*' fzf-preview 'px --top --color $word | batcat --style=numbers --color=always -n=8 || less'

#     zstyle ':fzf-tab:complete:git-(diff|restore):*' fzf-preview 'git diff $word | batcat --style=numbers --color=always -n=6 || less'

#     zstyle ':fzf-tab:complete:git-log:*' fzf-preview 'git log --color=always $word | batcat --style=numbers --color=always -n=6 || less'

#     zstyle ':fzf-tab:complete:git-help:*' fzf-preview 'git help $word | batcat --style=numbers --color=always -n=6 || less'

#     zstyle ':fzf-tab:complete:git-show:*' fzf-preview \
#         "case $group in
# 	        'commit tag') git show  $word | batcat --style=numbers --color=always -n=6 || less
#             ;;
# 	        *) git show $word | batcat --style=numbers --color=always -n=6 || less
#             ;;
# 	    esac"
...
#             ;;
# 	        'recent commit object name') git show --color=always $word | batcat --style=numbers --color=always -n=6 || less
#             ;;
# 	        *) git log --color=always $word | batcat --style=numbers --color=always || less
#             ;;
# 	    esac"

#     # Docker
#     zstyle ':fzf-tab:complete:docker-container:argument-1' fzf-preview 'docker container $word --help | batcat --style=numbers --color=always -n=8 || less'
#     zstyle ':fzf-tab:complete:docker-image:argument-1' fzf-preview 'docker image $word --help | batcat --style=numbers --color=always -n=8 || less'
#     zstyle ':fzf-tab:complete:docker-inspect:' fzf-preview 'docker inspect $word | batcat --style=numbers --color=always -n=8 || less'
#     zstyle ':fzf-tab:complete:docker-(run|images):argument-1' fzf-preview 'docker images $word'
#     zstyle ':fzf-tab:complete:((\\|*/|)docker|docker-help):argument-1' fzf-preview 'docker help $word |  batcat --style=numbers --color=always -n=8 || less'
#     # df
...
#     # Man
#     zstyle ':fzf-tab:complete:(\\|*/|)man:' fzf-preview 'man $word | batcat --style=numbers --color=always --n=6 || less'
