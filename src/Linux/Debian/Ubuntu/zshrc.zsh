...
TYPEWRITTEN_ARROW_SYMBOL="󰄾"
TYPEWRITTEN_RELATIVE_PATH="adaptive"
TYPEWRITTEN_CURSOR="terminal"
# TYPEWRITTEN_LEFT_PROMPT_PREFIX=""
TYPEWRITTEN_LEFT_PROMPT_PREFIX_FUNCTION="[${USER}@$(hostname)]"
# TYPEWRITTEN_RIGHT_PROMPT_PREFIX=
TYPEWRITTEN_RIGHT_PROMPT_PREFIX_FUNCTION="$(date +%H:%M:%S)"
...
[[ -n $(command -v neofetch) ]] && [[ $(tty) = "/dev/pts/0" ]] && neofetch
